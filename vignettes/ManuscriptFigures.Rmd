...
# rmarkdown::render('ManuscriptFigures.Rmd', output_format = 'pdf_document');
...
for (d in directions) {
    create.phylogenetic.tree(
        filename = paste0('figures/2G_multi-sample-dendrogram-', d, '.png'),
        phy.dt,
        bg = background,
...
include_graphics(paste0('figures/2G_multi-sample-dendrogram-', directions, '.png'));
```
\pagebreak
