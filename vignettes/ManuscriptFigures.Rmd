...
opts_chunk$set(
    ...
    message = FALSE,
    fig.align = 'center',
    # rmarkdown defaults to fig.retina = 2, which quadruples the raster pixels
    # of every embedded figure. This vignette has 32 chunks, which pushed
    # inst/doc past 12 Mb on its own.
    dpi = 96,
    fig.retina = 1
    );
